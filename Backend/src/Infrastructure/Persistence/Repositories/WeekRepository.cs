...
public class WeekRepository : IWeekRepository
{
    ...
    public async Task<List<Weeks>> GetByAcademicYearAsync(int academicYearId)
    {
        return await _context.Weeks
            .AsNoTracking()
            .Include(w => w.AcademicYear)
    ...
    public async Task<bool> HasDateIntersectionAsync(int academicYearId, DateTime startDate, DateTime endDate, int? excludedId = null)
    {
        IQueryable<Weeks> query = _context.Weeks
            .AsNoTracking()
            .Where(w => w.AcademicYearId == academicYearId);
    ...
    public async Task AddRangeAsync(IEnumerable<Weeks> weeks)
    {
    ...
    {
        week.AcademicYear = null;
        week.AcademicPeriod = null;
